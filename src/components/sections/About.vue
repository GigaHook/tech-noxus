...
const rows = [
  {
    ...
    text: 'Ваш ребёнок научится основам вёрстке сайтов и интерфейсов с нуля - от тегов HTML до адаптивной вёрстки и анимаций на CSS, на практических примерах изучит всё - от семантики до современных технологий.',
    img: 'LayoutSvg',
  },
  {
